...
export const metadata = {
  title: 'Blog & Guías de Inversión Inmobiliaria | Norte Chico Chancay y Huaral',
  description: 'Artículos de análisis, guías de saneamiento legal SUNARP, plusvalía cerca al Megapuerto de Chancay y preguntas frecuentes sobre compra de terrenos en el Norte Chico.',
  alternates: {
    canonical: 'https://inmobiliarianortechico.pe/blog',
  },
  openGraph: {
    title: 'Blog Inmobiliario & Centro de Inteligencia | Inmobiliaria Norte Chico',
    description: 'Análisis de plusvalía del Megapuerto de Chancay, guías legales SUNARP y preguntas frecuentes para inversionistas.',
    url: 'https://inmobiliarianortechico.pe/blog',
  ...
  twitter: {
    ...
    title: 'Blog & Guías de Inversión | Inmobiliaria Norte Chico',
    description: 'Aprende a invertir seguro en terrenos cerca al Megapuerto de Chancay y Huaral.',
...
const faqItems = [
  {
    ...
    answer: 'El Megapuerto Multipropósito de Chancay convertirá la zona en el principal hub marítimo del Pacífico Sur hacia Asia. Esto genera una demanda masiva de infraestructura comercial, residencial y logística, proyectando una revalorización continua de los terrenos a corto y mediano plazo.'
  },
  {
...
export default async function BlogPage() {
  ...
  const jsonLdBlog = {
    ...
    '@type': 'Blog',
    'name': 'Blog Inmobiliario & Centro de Conocimiento Norte Chico',
    'description': 'Guías de inversión, saneamiento legal SUNARP y análisis inmobiliario en Chancay y Huaral.',
    'url': 'https://inmobiliarianortechico.pe/blog',
    'blogPost': articles.map(art => ({
      ...
      'image': `https://inmobiliarianortechico.pe${art.image}`
    }))
  };
  ...
  const jsonLdBreadcrumb = {
    ...
    'itemListElement': [
      ...
      },
      {
        '@type': 'ListItem',
        'position': 2,
        'name': 'Blog & Guías de Inversión',
        'item': 'https://inmobiliarianortechico.pe/blog'
      }
    ]
  };
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([jsonLdBlog, jsonLdFaq, jsonLdBreadcrumb]) }}
      />
      <BlogClient articles={articles} faqItems={faqItems} />
    </>
  );
}
